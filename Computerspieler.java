...
// --request -> confirm -> update ----------------------------------------------
    ...
    public Move request() throws Exception, RemoteException{
      if(check==1){
        ...
        ArrayList<Move> possiblemove=(ArrayList<Move>)myviewer.getPossibleMoves();// mit Hilfe von myVierwer kann ich die possible moves bekommen
        possiblemove.remove(MoveType.Surrender);
