...
// --request -> confirm -> update ----------------------------------------------
    ...
    public Move request() throws Exception, RemoteException{
      if(check==1){
        ...
        ArrayList<Move> possiblemove=(ArrayList<Move>)myviewer.getPossibleMoves();//mit Hilfe von diese Viewer kann ich die possiblemoves bekommen
        ...
        for (int i=0;i<listsize;i++){
          ...
          int n1=board.getneighbours(flower1);
          int n2=board.getneighbours(flower2);
